...
menu_text:
	text_block $224B, "% WORLD"
	text_block $226B, "% LEVEL"
	text_block $228B, "% P-UPS"
...
MushroomIconData:
		.byte $22, $49, $87, $24, $24, $24, $24, $24, $24, $24
DrawMushroomIcon:
		ldy #$0a
		lda VRAM_Buffer1_Offset
		clc
...
@checked_ann_r:                ;
	cpy #$16                    ; we are playing LL / ANN, are we past the end of the game?
...
@checked_ann_l:                ;
	...
	beq @store                 ; and store
    ldy #$15                   ; we are playing LL / ANN, wrap to world D
@store:                        ;

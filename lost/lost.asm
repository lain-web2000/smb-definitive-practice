...
WaterAnimBanks:
	  .byte WaterF1, CHR_LOST_BG+1, WaterF3, WaterF4
...
NextArea: inc AreaNumber            ;increment area number used for address loader
          ...
          bcc NotEndW
          jmp NextWorld
NotEndW:  jsr Enter_LL_LoadAreaPointer    ;get new level pointer
...
CopyFToR: tya                      ;move bowser's rear object position value to A
          ...
          tax
		  jsr OffscreenBoundsCheck ;check if bowser half went offscreen
...
StartTheGame:
         jsr Enter_LL_LoadAreaPointer    ;update area pointer for world 1-1
         inc Hidden1UpFlag
...
InitWorldPos:
           ...
           lda #CHR_DEF_TITLE   ;load title screen graphics data
           jsr SwitchBG_CHR3
...
Continue:
        ldy #$04
        sty OffScr_NumberofLives    ;give five lives
        sta LevelNumber
...
PrimaryGameSetup:
      ...
      lda #$04
      sta OffScr_NumberofLives    ;give each player five lives

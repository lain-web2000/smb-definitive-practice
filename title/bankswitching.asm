...
BANK_AdvanceToLevel:
    ...
    bcc @SMB1Levels                     ; if not, branch ahead to store world
    inc HardWorldFlag                   ; otherwise increment flag for 2J levels
    sbc #$09                            ; subtract world number by 9 to correctly store
@SMB1Levels:
    ...
    inc PrimaryHardMode                 ; otherwise set hard mode for letter worlds
@NumberWorlds:
